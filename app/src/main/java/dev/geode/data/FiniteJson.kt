...
internal fun JSONObject.finiteDouble(name: String, fallback: Double): Double {
...
internal fun JSONObject.finiteRequiredDouble(name: String, fallback: Double = 0.0): Double {
