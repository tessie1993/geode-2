...
class TrackLibraryFolderTest {
    ...
    fun `same named tracks in distinct imported folders stay distinct`() {
        ...
        val second = LibraryTrack("content://provider/b", "Song", fileName = "song.mp3", sizeBytes = 100L, folder = "content://provider/two")
